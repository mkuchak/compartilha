      ...
      <div
        ...
        <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
          <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
            {/*<img src="https://a.imagem.app/AJTH6i.png" alt="" />*/}
          <Image src={footerIMG}
          alt="image"
          width={200}
          height={90}
          ...
          {/*<p className="mt-2 text-sm text-white">Feito com amor </p>*/}
        </div>
      ...
      <div className="bg-indigo-900">
        <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
          <p className="text-white text-sm text-center sm:text-left">© 2021 -
            <a href="https://compartilha.org"
               rel="noopener noreferrer"
               className="text-gray-400 ml-1"
               target="_blank">Compartilha.org
            </a>
          </p>
